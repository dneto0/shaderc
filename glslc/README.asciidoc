...
Sets the lowest automatically assigned binding number for images.
The default is 0.

[[option-f-sampler-binding-base]]
==== `-fsampler-binding-base=value`

Sets the lowest automatically assigned binding number for samplers.
The default is 0.

[[option-f-texture-binding-base]]
==== `-ftexture-binding-base=value`

Sets the lowest automatically assigned binding number for textures.
The default is 0.
...
The default is 0.
>>>>>>> Add glslc options to set binding base numbers
